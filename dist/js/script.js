...
marker.addListener('click', function(){
	infoWindow.open(map, marker);
      ...
      addMarker({
      	...
      	iconImage:'http://1.bp.blogspot.com/-PxgBgllxJrE/VpgleojkmyI/AAAAAAAAEAs/NOibbG2gPUc/s1600/google-marker-preview1-177x300.png'});
